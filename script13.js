	...
	songs: [
		...
		,
			...
			lyrics: "Hey pups! Who wants to play soccer?"
						...
						{
			name: "Take care of",
			path: "13/CAN YOU get ryder and the paw patrol and take care of it.ogg",
			lyrics: "Can you get Ryder and the Paw Patrol and take care of it?"
		},
						{
			name: "Made everything worse",
			path: "13/i didnt save the day i just made everything woese.ogg",
			lyrics: "I'm sorry, i didn't save the day<br>I just made everything worse :("
		},
						{
			name: "Don't have to stop",
			path: "13/i dont have to stop ryders soccer game.ogg",
			lyrics: "I don't have to stop Ryder's soccer game"
		},
						{
			name: "Take care of everything",
			path: "13/ill take care of everything just like apollo the super pup does.ogg",
			lyrics: "I'll take care of everything<br> just like Apollo the super pup does"
		},
						{
			name: "Paw Patrol - super pup 2",
			path: "13/Paw Patrol - super pup 2.MP3",
			lyrics: "Paw Patrol - super pup 2"
		},
						{
			name: "Just the pup i need",
			path: "13/rubble just the pup i need.ogg",
			lyrics: "Rubble! Just the pup I need"
		}

	],
	last_class: function(){
		const how_many_last_class = 6;
